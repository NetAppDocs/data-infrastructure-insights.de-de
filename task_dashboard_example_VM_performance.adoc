...
summary: Schritt-für-Schritt-Anleitung zur Erstellung eines Dashboards zur Leistungsanalyse virtueller Maschinen mit Tabellen, Diagrammen und Widgets zum Vergleich von VM- und Speichermetriken. 
...
[role="lead"]
In diesem Schritt-für-Schritt-Tutorial wird gezeigt, wie ein umfassendes Dashboard zur Leistung virtueller Maschinen erstellt werden kann. Widgets werden erstellt, die VM-Leistungsdaten visualisieren, Backend-Speichermetriken mit der Frontend-VM-Leistung vergleichen und Zusammenhänge zwischen VM-Latenz und E/A-Anforderung analysieren, um bessere Einblicke in den Betrieb zu ermöglichen.
