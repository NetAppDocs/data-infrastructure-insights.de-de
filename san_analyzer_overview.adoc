...
Wenn Sie auf ein Objekt oder eine Gruppe klicken, wird ein Schiebefenster mit zusätzlichen Details zum Objekt und seinen Verbindungen geöffnet. Das Slideout enthält Registerkarten mit einer Übersicht, Portdetails und Zoneninformationen, falls verfügbar.
