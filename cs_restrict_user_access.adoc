...
summary: Erkannte Angriffe werden sofort gestoppt, indem der Zugriff kompromittierter Benutzer automatisch oder manuell eingeschränkt wird, um weiteren Schaden an Dateisystemen über mehrere Speichervolumes hinweg zu verhindern. 
---
