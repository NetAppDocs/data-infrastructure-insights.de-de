...
summary: Ein einheitlicher Überblick über den Zustand Ihrer Speicherumgebung wird durch umfassendes Monitoring ermöglicht, das Leistungs-, Kapazitäts-, Konfigurations- und Komponentenwarnungen zu aussagekräftigen Gesundheitsbewertungen zusammenfasst. 
---
...
[role="lead"]
Data Infrastructure Insights überwacht den Zustand Ihrer Speicherumgebung durch die Erfassung von Leistung, Kapazität, Konfiguration und Komponentenstatus. Das System berechnet aus den Überwachungsmeldungen in diesen Kategorien einheitliche Zustandsbewertungen, bietet einen klaren Überblick über den Systemzustand und ermöglicht eine proaktive Problemlösung.
