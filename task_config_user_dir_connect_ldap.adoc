...
+
** Installieren Sie link:http://ldaptool.sourceforge.net/["LDAP Explorer"] oder link:http://jxplorer.org/["Java LDAP Explorer"] auf einem beliebigen Windows-Rechner, der eine Verbindung zum LDAP-Server herstellen kann.
