...
link:media/DII_ON-PREM_Notice_Nov2025.pdf["Hinweis für Data Infrastructure Insights (ehemals Cloud Insights), Fenster=_blank"]

link:media/DII_WS_Notice_Nov2025.pdf["Hinweis zur Workload-Sicherheit (ehemals Cloud Secure), Fenster=_blank"]
