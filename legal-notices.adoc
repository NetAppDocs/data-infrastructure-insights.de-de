...
link:media/DII_Notice-Sept_2025.pdf["Hinweis zu Data Infrastructure Insights (ehemals Cloud Insights)"]

link:media/WS_Notice-Sept_2025.pdf["Hinweis zur Workload-Sicherheit (früher Cloud Secure)"]
