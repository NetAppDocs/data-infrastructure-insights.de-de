...
link:media/DII_ON-PREM_Notice_Nov2025.pdf["Hinweis zu Data Infrastructure Insights (ehemals Cloud Insights)"]

link:media/DII_WS_Notice_Nov2025.pdf["Hinweis zur Workload-Sicherheit (früher Cloud Secure)"]
