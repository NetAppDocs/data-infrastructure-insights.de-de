...
summary: Vorgefertigte Dashboards können aus der Galerie importiert werden, um schnell Geschäftseinblicke zu erhalten, oder benutzerdefinierte Dashboards, die exportiert wurden, um Konfigurationen mandantenübergreifend zu teilen. 
...
[role="lead"]
Vorgefertigte Dashboards aus der Galerie ermöglichen einen schnellen Einblick in Ihre Infrastruktur, alternativ lassen sich benutzerdefinierte Dashboards importieren, die aus anderen Mandanten exportiert wurden. Galerie-Dashboards sind auf die Datensammler Ihrer Umgebung zugeschnitten und darauf ausgelegt, spezifische Geschäftsfragen zu beantworten, während exportierte Dashboards das Teilen nützlicher Konfigurationen über mehrere Mandanten hinweg ermöglichen.
