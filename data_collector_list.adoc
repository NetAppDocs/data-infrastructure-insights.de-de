...
| link:task_dc_pure_flashblade.html["Pure FlashBlade"] | Infrastruktur 
...
| link:task_dc_redhat_openshift virtualization.html[Red Hat OpenShift Virtualisierung ] | Infrastruktur 
