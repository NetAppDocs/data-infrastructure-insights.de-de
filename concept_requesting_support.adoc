...
[role="lead"]
Data Infrastructure Insights bietet umfassende Supportoptionen, darunter Selbsthilfe-Ressourcen, Community-Foren, Dokumentation und technischen Support. Der Zugriff auf diese Supportressourcen erfolgt über *Hilfe > Support*, und durch die Aktivierung der Supportberechtigung wird vollständige technische Unterstützung per Web-Ticket und Telefon freigeschaltet.
...
Es wird dringend empfohlen, das Kontrollkästchen zu aktivieren, um einem NetApp Support Engineer während Ihrer Support-Sitzung Zugriff auf Ihre Data Infrastructure Insights-Website zu gewähren. Dadurch kann der Engineer das Problem beheben und Ihnen helfen, es schnell zu lösen. Solange der Support Engineer Zugriff auf Ihre Website hat, kann er alle Admin-Funktionen ausführen.

Wenn Ihr Problem gelöst ist oder Ihre Support-Sitzung beendet ist, können Sie das Kontrollkästchen deaktivieren.

Sie können Unterstützung anfordern, indem Sie die link:https://www.netapp.com/support-and-training/["NetApp Support Site"] aufrufen. Es ist ein aktives Data Infrastructure Insights Abonnement erforderlich.
