...
summary: Zentralisierte Einblicke in das Speichermanagement stehen mit umfassenden Berichten zur Kapazitätsauslastung, zu Leistungstrends und Ressourcenprognosen für proaktives Rechenzentrumsmanagement zur Verfügung. 
...
[role="lead"]
Das Storage Manager Dashboard bietet durch umfassende Berichts- und Visualisierungsfunktionen zentrale Einblicke in die Speicherumgebung. Kapazitätsauslastung lässt sich überwachen, Leistungstrends im Zeitverlauf verfolgen und aktuelle Kennzahlen mit zulässigen Bereichen vergleichen, sodass fundierte Entscheidungen zur Wartung des Rechenzentrums und zur Ressourcenplanung möglich sind.
