...
summary: Direkter Zugriff auf die Reporting-Datenbank über APIs, wobei Cognos für benutzerdefinierte Integrationen, automatisierte Berichterstellung und erweiterte Datenanalyse-Workflows umgangen wird. 
...
[role="lead"]
Direkter Zugriff auf die Data Infrastructure Insights Reporting-Datenbank über OData v4-kompatible APIs, wobei die Cognos-Oberfläche umgangen wird, bietet mehr Flexibilität. Dadurch werden benutzerdefinierte Integrationen, automatisierte Berichtsworkflows und erweiterte Datenanalysen für Benutzer ermöglicht, die programmatischen Zugriff auf ihre Infrastrukturdaten benötigen.
...
Die Data Infrastructure Insights Reporting API folgt dem link:https://www.odata.org/["OData v4"] (Open Data Protocol)-Standard für die Abfrage der Reporting-Datenbank. Weitere Informationen sind unter link:https://www.odata.org/getting-started/basic-tutorial/["dieses Tutorial"] OData verfügbar.
