...
* Port 443 (oder 8443, wenn konfiguriert)
...
| StorageGRID Host-IP-Adresse | Management-IP-Adresse des StorageGRID (Grid Manager) 


| Benutzername | Name, der zum Anmelden bei StorageGRID (Grid Manager) verwendet wird 


| Passwort | Passwort für die Anmeldung bei StorageGRID (Grid Manager) 
|===
