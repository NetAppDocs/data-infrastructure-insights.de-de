...
. Zu jedem Zeitpunkt sollte ein Datensammler ausgeführt werden, ein anderer wird als _Gestoppt_ angezeigt.
+
Der aktuell „laufende“ Datensammler des SVM wird als _Running_ angezeigt.  Der aktuell „gestoppte“ Datensammler des SVM wird als _Gestoppt_ angezeigt.

. Bei jeder Umschaltung ändert sich der Status des Datensammlers von „läuft“ zu „gestoppt“ und umgekehrt.
