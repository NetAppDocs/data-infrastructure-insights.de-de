...
NOTE: Die Leistungserfassung von Data Infrastructure Insights bei VPLEX-Clustern erfordert, dass der Performance-Archivierungsdienst betriebsbereit ist, um die .CSV-Dateien und Protokolle zu füllen, die Data Infrastructure Insights über SCP-basierte Dateikopien abruft. NetApp hat beobachtet, dass viele VPLEX-Firmware-Upgrades/Management-Station-Updates diese Funktionalität außer Betrieb setzen. Kunden, die solche Upgrades planen, sollten Dell/EMC proaktiv fragen, ob ihr geplantes Upgrade diese Funktionalität außer Betrieb setzt und, falls ja, wie sie diese wieder aktivieren können, um Lücken in der Performance-Transparenz zu minimieren. Der VPLEX-Performance-Code von Cloud Insights prüft bei jeder Abfrage, ob alle erwarteten Dateien vorhanden sind und ob sie ordnungsgemäß aktualisiert werden; falls sie fehlen oder veraltet sind, protokolliert Data Infrastructure Insights Fehler bei der Leistungserfassung.
