...
summary: Benutzerdefinierte Abfragen ermöglichen die Suche, Filterung und Analyse von Infrastruktur-Assets und -Metriken mit detaillierter Kontrolle, flexibler Gruppierung und anpassbarer Ergebnisdarstellung. 
...
[role="lead"]
Leistungsstarke Abfragen ermöglichen die Suche nach Infrastrukturressourcen auf granularer Ebene mit flexiblen Filter-, Gruppierungs- und Sortierfunktionen. Gezielte Suchvorgänge unterstützen die Identifikation spezifischer Ressourcen, die Analyse von Leistungskennzahlen und die Organisation der Ergebnisse genau nach Bedarf.
