...
summary: Konfiguration des Pure FlashBlade Storage-Datensammlers 
---
...
[role="lead"]
Data Infrastructure Insights verwendet den Pure Storage FlashBlade Datenkollektor, um Inventar- und Leistungsdaten von FlashBlade Clustern zu erfassen, die Version 2 ihrer REST API bereitstellen.
