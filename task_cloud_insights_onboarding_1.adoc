...
Wenn Sie sich zum ersten Mal bei Data Infrastructure Insights anmelden, lesen Sie sich über alle Funktionen von Data Infrastructure Insights durch. Wenn Sie bereit sind, loszulegen, klicken Sie auf „Testversion anfordern“ und geben Sie Ihre Daten ein.

Im Rahmen der Einrichtung Ihres Testmandanten wählen Sie die Region, in der Ihr Mandant gehostet werden soll, und ob Sie Ihren Mandanten auf AWS oder Azure betreiben möchten.
...
Sobald Ihr Mandant erstellt wurde, können Sie sich jederzeit einfach im NetApp BlueXP Portal anmelden und zu folgendem navigieren: link:https://services.cloud.netapp.com["Cloud-Dienste"] Seite und wählen Sie *Zu Data Infrastructure Insights wechseln*.
