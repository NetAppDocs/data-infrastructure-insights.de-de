...
. Dateitypen: Warnungen vor Dateimanipulation bei bestimmten <<file-types,Zulässige Dateitypen>> Dateitypen unterdrücken
...
* Verzeichnisausschlussliste: Unterstützt bis zu vier Ebenen von Verzeichnispfaden, beginnend mit dem Verbindungspfad. Alle Unterverzeichnisse und Dateien unter diesem Pfad werden von der Alarmgenerierung ausgeschlossen. Platzhalter in Verzeichnispfaden werden nicht unterstützt.


image:ws_alert_exclusions_users.png["Benutzer, die von Warnungen ausgeschlossen sind"]

image:ws_alert_exclusions_paths.png["Pfade für Alarmausschlüsse"]
