...
** Die Anomalieerkennung überwacht und warnt bei Änderungen in den Mustern Ihrer Daten.
** _Attribute_ überwacht Änderungen an den Attributen eines Objekts, wie das Verschieben eines Objekts in ein neues Rechenzentrum
