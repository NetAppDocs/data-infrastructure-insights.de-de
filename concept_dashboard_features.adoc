...
NOTE: Bei der Erstellung eines Monitors prüft DII alle vorhandenen Daten der Vorwoche auf signifikante Datenspitzen oder -einbrüche; diese gelten als Anomalien. In der ersten Woche nach der Monitorerstellung (der Lernphase) kann es zu verstärktem Rauschen in den Warnmeldungen kommen. Um dieses Rauschen zu minimieren, werden nur Spitzen oder Einbrüche, die länger als 30 Minuten dauern, als Anomalien gewertet und lösen Warnmeldungen aus. In der Folgewoche, wenn mehr Daten analysiert werden, nimmt das Rauschen in der Regel ab, und nur ein nachfolgender signifikanter Spitzen- oder Einbruch wird als Anomalie gewertet.
