...
NOTE: Da die NetApp Konsole über ein eigenes Zeitlimit für die Benutzeranmeldung von 7 Tagen verfügt, muss sich Data Infrastructure Insights bei diesem Ereignis ebenfalls abmelden.  Sie können sich einfach erneut anmelden und Ihr Dashboard wird weiterhin angezeigt.
