...
NOTE: DII prüft alle vorhandenen Daten der Woche vor der Monitorerstellung und erkennt signifikante Datenspitzen oder -einbrüche, die länger als 30 Minuten andauern – diese gelten als Anomalien. In der zweiten Woche (der Lernphase), in der mehr Datenpunkte erfasst und analysiert werden, kann es zu verstärktem „Rauschen“ in den Warnmeldungen kommen. Dieses „Rauschen“ nimmt in der Regel ab, wenn in den folgenden Wochen mehr Daten analysiert werden.
