...
summary: Workload Security-Agenten überwachen die Benutzeraktivität und erkennen Sicherheitsbedrohungen in Ihrer Speicherumgebung. 
---
...
[role="lead"]
Workload Security-Agenten sind unerlässlich, um die Benutzeraktivitäten zu überwachen und potenzielle Sicherheitsbedrohungen in Ihrer Speicherinfrastruktur zu erkennen. Dieser Leitfaden enthält eine Schritt-für-Schritt-Anleitung zur Bereitstellung von Agenten in Ihrer Umgebung. Bevor Sie beginnen, stellen Sie sicher, dass Ihr Agentenserver die folgenden Anforderungen erfüllt: link:concept_cs_agent_requirements.html["Systemanforderungen"]Die
