...
Das Security Dashboard bietet Ihnen einen sofortigen Überblick über Ihre aktuelle Sicherheitslage und zeigt Diagramme zur Hardware- und Software-Volumenverschlüsselung, zum Status der Anti-Dateimanipulation und zu den Cluster-Authentifizierungsmethoden. Sicherheitskriterien werden anhand von Empfehlungen bewertet, die in der link:https://www.netapp.com/pdf.html?item=/media/10674-tr4569.pdf["* NetApp Security Hardening Guide für ONTAP 9*"] definiert sind.

Wählen Sie eine der Verschlüsselungs- oder Anti-Dateimanipulations-Zählungen aus, um tiefer in Ihre Umgebung einzutauchen.
