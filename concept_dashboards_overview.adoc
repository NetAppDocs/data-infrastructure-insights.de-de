...
summary: Individuelle Dashboards mit flexiblen Widgets ermöglichen die Visualisierung von Infrastrukturdaten, die Überwachung von Leistungstrends und den Aufbau von operativen Ansichten, die auf spezifische Überwachungsanforderungen zugeschnitten sind. 
...
[role="lead"]
Individuelle Dashboards bieten die wichtigsten operativen Einblicke. Es stehen verschiedene Widget-Typen zur Auswahl, darunter Tabellen, Diagramme, Messinstrumente und Grafiken, um Infrastrukturdaten exakt nach Wunsch zu visualisieren, was bessere Entscheidungen und ein effektiveres Monitoring ermöglicht.
