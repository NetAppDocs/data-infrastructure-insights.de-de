...
TIP: Sobald ein Agent auf einem Server oder einer VM installiert ist, sammelt Data Infrastructure Insights Metriken von diesem System sowie von allen konfigurierten Datensammlern. Diese Metriken werden als „Node“-Metriken erfasst.
