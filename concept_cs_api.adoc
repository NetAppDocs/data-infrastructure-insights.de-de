...
summary: Greifen Sie über eine REST-API mit sicherer tokenbasierter Authentifizierung auf Workload-Sicherheitsdaten zu, um die Integration mit CMDBs, Ticketsystemen und anderen Unternehmensanwendungen zu ermöglichen. 
---
