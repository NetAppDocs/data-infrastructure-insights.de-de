...
| Betriebssystem  a| 
Ein Computer, auf dem eine lizenzierte Version einer der folgenden läuft:
...
Auf diesem Computer sollte keine andere Anwendungssoftware laufen. Ein dedizierter Server wird empfohlen.

Wenn Sie SELinux verwenden, wird empfohlen, die folgenden Befehle auf dem Datenerfassungssystem auszuführen:
...
50 GB (100 GB empfohlen)

Unter Linux sollte der Speicherplatz folgendermaßen zugewiesen werden:

* /opt/netapp 10 GB (20 GB für große Umgebungen)
* /var/log/netapp 40 GB (80 GB für große Umgebungen)
* Im Verzeichnis /tmp muss während der Installation mindestens 1 GB verfügbar sein.


Ihr Dateisystem verwendet möglicherweise etwas Speicherplatz für seinen Overhead. Dies sind die Mindestspeicherplätze, die vor der Installation  sein sollten.
| 50 GB 
