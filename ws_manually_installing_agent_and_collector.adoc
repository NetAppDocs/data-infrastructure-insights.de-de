...
.. Hinweis: Das Agenteninstallationsprogramm sollte in einen anderen Ordner heruntergeladen werden als in den Ordner, der den laufenden Agenten enthält.
...
+
Wenn der Agent beispielsweise in „/test_user/apps“ ausgeführt wird, wäre der Befehl:
