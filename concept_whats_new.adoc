...
Wir stellen vor: Unsere neueste Funktion zur Verbesserung Ihrer Sicherheits- und Ressourcenverwaltungsfunktionen! Mit der erweiterten forensischen Gruppenkalzfunktion und der hierarchischen Unterstützung mehrerer Gruppen nach können Sie jetzt ganz einfach ermitteln, welche Benutzer auf bestimmte Ordner zugegriffen haben, die aktivsten Benutzer und Freigaben ermitteln und das Risiko proaktiv managen, indem Sie aktive Client-IP-Adressen verfolgen. Optimieren Sie Ihre Speicher- und Bandbreitennutzung, indem Sie die Dateien und Ordner erkennen, auf die am häufigsten zugegriffen wird, und erhalten Sie eine bessere Kontrolle über den Systemzugriff, indem Sie echte Benutzer identifizieren.

image:forensics-group-by-example-screen.png["forensics-Beispielbildschirm, der die Gruppe nach zeigt"]
...
Der link:task_dc_vmware.html#mapping-vmware-tags-to-cloud-insights-annotations["VMware"] Datensammler ermöglicht das Befüllen von Cloud Insights Textanmerkungen mit Tags mit demselben Namen, die auf VMware konfiguriert sind.
...
Cloud Insights weist regelmäßig eine Reihe von interessanten neuen Vorschaufunktionen auf. Wenn Sie eine oder mehrere dieser Funktionen in der Vorschau anzeigen möchten, wenden Sie sich an Ihrenlink:https://www.netapp.com/us/forms/sales-inquiry/cloud-insights-sales-inquiries.aspx["NetApp Vertriebsteam"], um weitere Informationen zu erhalten.
...
IMPORTANT: Wenn Sie ein aktueller Premium Edition-Kunde sind und Ihre Berichte behalten möchten, lesen Sie dies link:reporting_user_roles.html#important-note-for-existing-customers["Wichtiger Hinweis für Bestandskunden"].
