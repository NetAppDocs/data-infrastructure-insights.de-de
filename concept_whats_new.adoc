...
=== Der AI Assistant von DII ist für alle verfügbar!

Der Data Infrastructure Insights AI Assistant ist als Vorschauversion verfügbar und beinhaltet nun die folgenden Verbesserungen:

* Azure region availability: Für Kunden, deren DII-Site in Azure gehostet wird, steht Ihnen jetzt der DII Assistant zur Verfügung.
* Bis zu 7 Tage an Daten: Der Assistent kann jetzt auf bis zu 7 Tage hochauflösender Metriken zugreifen, was eine umfassendere Datenanalyse und Einblicke ermöglicht.
