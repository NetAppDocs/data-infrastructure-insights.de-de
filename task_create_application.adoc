...
summary: Sie definieren Applikationen, die Sie dann nach Bedarf auf Assets in Ihrer Umgebung anwenden. 
...
[role="lead"]
Zum Nachverfolgen von Daten, die mit bestimmten, in Ihrer Umgebung ausgeführten Applikationen verknüpft sind, können Sie die Applikationen in Data Infrastructure Insights definieren.
