...
summary: Konfigurieren Sie automatisierte Reaktionsrichtlinien, um bei Sicherheitsvorfällen sofort Maßnahmen zu ergreifen, einschließlich Snapshots, Einschränkung des Benutzerzugriffs und Webhook-Benachrichtigungen bei Bedrohungen und verdächtigem Verhalten. 
---
...
image:ws_add_attack_policy.png["Fügen Sie einen Dialog zur Angriffsrichtlinie hinzu, der ein Webhook-Dropdown-Menü anzeigt, Breite=300"]
