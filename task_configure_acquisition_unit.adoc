...
Wenn festgestellt wird, dass Ihre AU beim Versuch, eine Verbindung zu DII herzustellen, blockiert ist, empfiehlt es sich, diese Endpunkte zu Ihrem Proxy hinzuzufügen:
...
Spezifische NetApp Console Proxy-Endpunkte, die möglicherweise benötigt werden, sind in der link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console-previous.html#update-endpoint-list["Console Setup Administrator"] Dokumentation aufgeführt.
