...
summary: Abfrageergebnisse, Dashboard-Tabellen, Landingpage und andere Daten können zur externen Analyse, Berichterstellung und Integration mit anderen Anwendungen unter Verwendung von asynchroner Verarbeitung in .CSV-Dateien exportiert werden. 
...
[role="lead"]
Daten können aus Abfragen, Dashboard-Tabellen-Widgets und Landingpage-Tabellen in .CSV-Dateien für externe Analysen, Berichte und die Integration mit anderen Anwendungen exportiert werden. Der asynchrone Exportprozess ermöglicht es, während der Verarbeitung großer Datensätze im Hintergrund weiterzuarbeiten.
