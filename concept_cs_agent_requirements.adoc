...
summary: Stellen Sie sicher, dass Ihre Bereitstellungsumgebung für den Workload Security Agent die Mindestanforderungen an Betriebssystem, CPU, Arbeitsspeicher und Festplattenspeicher erfüllt, um eine optimale Leistung und Datenerfassung zu gewährleisten. 
