...
summary: Verwenden Sie den SVM Event Rate Checker, um die NFS/SMB-Ereignisraten zu messen und die optimale Agentengröße zu bestimmen, bevor Sie Workload Security-Datensammler bereitstellen. 
