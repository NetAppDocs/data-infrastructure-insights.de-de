...
summary: Es werden bewährte Methoden für das Finden der richtigen Kennzahlen, das effektive Filtern von Assets und das Konfigurieren von Widgets vorgestellt, um leistungsstarke und aussagekräftige Dashboards zu erstellen. 
...
[role="lead"]
Die Dashboard-Erstellung gelingt mit bewährten Strategien zur Ermittlung der richtigen Kennzahlen, zur effektiven Filterung von Assets und zur Konfiguration von Widgets für maximale Erkenntnisse. Diese Best Practices ermöglichen den Aufbau effektiverer Dashboards, die umsetzbare Informationen über die Infrastruktur liefern.
